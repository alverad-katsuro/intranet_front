...
import { getAnexoCategoriasAtivos, getAnexoDominiosAtivos, getAnexosAtivos, getAnexoSubCategoriasAtivos, saveAnexos, updateAnexos } from '../../api/api';
